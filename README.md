...
## News
- A new polygon detection Transformer will be released soon: (Poly-DETR)](https://github.com/Sun15194/Poly-DETR). Now, its corresponding paper "[Towards Instance Segmentation with Polygon Detection Transformers](https://arxiv.org/abs/2603.09245)" is available. (2026.03.20)
